...
const FORMAT_NUMBER_THRESHOLD = 10000000;
 ...
 */
export const formatFloat = (num: number, decimal = 2) =>
 ...
 */
export const formatNumberWithUnit = (num: number, decimal = 4) =>
  format(`.${decimal}s`)(num);
...
export const formatNumberWithLeadingZeros = (
  ...
  const numZerosToAdd = totalLength - numStr.length;
